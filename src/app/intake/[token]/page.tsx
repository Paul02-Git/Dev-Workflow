    ...
    <div className="min-h-screen bg-background px-4 py-12 text-foreground">
      <div className="mx-auto max-w-lg">
        ...
        <form action={submitIntakeAction} className="space-y-6 rounded-xl border border-border bg-card p-6">
          ...
          <SubmitButton pendingLabel="Creating…" className="w-full rounded-md bg-[#262626] px-4 py-2.5 text-sm font-semibold text-white hover:opacity-90 disabled:opacity-60">
            Create my account
          </SubmitButton>
        </form>
      </div>
