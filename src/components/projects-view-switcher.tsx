...
export function ProjectsViewSwitcher({ active, searchParamsString }: { active: string; searchParamsString: string }) {
  ...
  return (
    <div className="flex shrink-0 items-center gap-1 rounded-lg border border-border bg-muted p-1">
      ...
      <span
        className="ml-1 flex cursor-not-allowed items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium text-muted-foreground/50"
